...
class FenomenaService {
  ...
  final List<FenomenaModel> _fenomenaList = [
    FenomenaModel(
      ...
      poinPelajaran: [
        "☑️ Gerhana Bulan terjadi saat Bumi berada di antara Matahari dan Bulan.",
        "☑️ Warna merah terjadi karena hamburan Rayleigh di atmosfer Bumi.",
        "☑️ Gerhana bulan aman dilihat tanpa pelindung mata.",
      ],
      sumber: "BMKG, NASA",
    ),
    FenomenaModel(
      ...
      poinPelajaran: [
        "☑️ Meteor adalah debu/komet yang terbakar saat masuk atmosfer Bumi.",
        "☑️ Lyrid terjadi setiap tahun pada bulan April.",
        "☑️ Puncak terbaik diamati dari lokasi gelap setelah tengah malam.",
      ],
    ...
    FenomenaModel(
      ...
      poinPelajaran: [
        "☑️ Meteor ini berasal dari Komet Halley.",
        "☑️ Kecepatan meteor bisa mencapai 66 km/s.",
        "☑️ Waktu terbaik mengamati adalah sebelum fajar (pukul 03.00 - 05.00).",
      ],
      sumber: "In-The-Sky.org, NASA",
    ),
    FenomenaModel(
      ...
      poinPelajaran: [
        "☑️ Meteor Perseid berasal dari rasi Perseus.",
        "☑️ Komet induknya adalah Swift-Tuttle.",
        "☑️ Waktu terbaik mengamati mulai tengah malam hingga subuh.",
      ],
      sumber: "In-The-Sky.org, NASA",
    ),
    FenomenaModel(
      ...
      poinPelajaran: [
        "☑️ Sumber Geminid adalah asteroid 3200 Phaethon.",
        "☑️ Meteor ini bisa terlihat dari Indonesia mulai malam hingga dini hari.",
        "☑️ Puncak aktivitas hingga 150 meteor per jam di lokasi tanpa polusi cahaya.",
      ],
    ...
    FenomenaModel(
      ...
      poinPelajaran: [
        "☑️ Bulan purnama di perigee (jarak terdekat).",
        "☑️ Tampak lebih besar dan terang dari biasanya.",
        "☑️ Dapat diamati dengan mata telanjang sepanjang malam.",
      ],
    ...
    FenomenaModel(
      ...
      poinPelajaran: [
        "☑️ Konjungsi berarti kedua planet terlihat berdekatan dari sudut pandang Bumi.",
        "☑️ Fenomena ini dapat diamati dengan mata telanjang.",
        "☑️ Waktu terbaik: sebelum fajar (sekitar pukul 04.00 dini hari).",
      ],
    ...
    FenomenaModel(
      ...
      poinPelajaran: [
        "☑️ Okultasi adalah tertutupnya suatu benda langit oleh benda lain yang lebih dekat.",
        "☑️ Wilayah Indonesia berada di jalur ideal pengamatan.",
        "☑️ Disarankan menggunakan teleskop kecil atau teropong.",
      ],
    ...
    FenomenaModel(
      ...
      poinPelajaran: [
        "☑️ Oposisi berarti planet berseberangan dengan Matahari dari Bumi.",
        "☑️ Saturnus akan terlihat sangat terang sepanjang malam.",
        "☑️ Waktu terbaik untuk fotografi planet dengan teleskop.",
      ],
    ...
    FenomenaModel(
      ...
      poinPelajaran: [
        "☑️ Dikenal menghasilkan bolide (meteor sangat terang).",
        "☑️ Puncaknya 30 Juli.",
        "☑️ Cocok diamati dari belahan bumi selatan termasuk Indonesia.",
      ],
